    ...
    public class EntryScene : IScene
    {
        ...
        public void Update(DeltaTime deltaTime)
        {
            if(_enabled)
            {
                ...
                if(_buttonHandler.Update(_languageButton))
                {
                    _scenesManager.LoadScene<LanguageScene>();
                    DisableCurrentSceneText();
                }
            }
